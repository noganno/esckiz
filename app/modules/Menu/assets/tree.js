$(function () {
    ...
    $('.add').click(function (e) {
        ...
        console.log(title);
        if (title) {
            $.post("/menu/admin/add", {root: root, title: title}, function (response) {
                if (response.success == true) {
                    ...
                    var edit = $("<a>").attr('href', '/menu/admin/edit/' + response.id)
...
function deleteCategory(category_id, node) {
    if (confirm('Do you really want delete this menu?')) {
